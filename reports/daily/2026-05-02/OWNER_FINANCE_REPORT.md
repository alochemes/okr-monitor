...
- ❓ **K2** Daily 7pm OWNER/FINANCE report sent — _no daily report files in the last 2 days_
...
- **CEO synopsis — today vs expected** — _(DRY_RUN stub — see banner above)_
- **Product roadmap** — _(DRY_RUN stub — see banner above)_
- **Cost & token projection (next 14 days)** — _(DRY_RUN stub — see banner above)_
- **Growth metrics** — _(DRY_RUN stub — see banner above)_
...
| **K2** Daily 7pm OWNER/FINANCE report sent | [?] | no daily report files in the last 2 days | ≥99% of days |
...
| **K9** Strategy pod proposals (rolling 7d) | [OK] | 4 of 4 strategy agents shipped a proposal in last 7d | ≥4/week |
